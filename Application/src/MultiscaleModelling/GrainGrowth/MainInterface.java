...
public class MainInterface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 470, -1, -1));
        ...
        NeighborhoodComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Moore", "von Neumann", "Pentagonal Random", "Hexagonal Random" }));
        ...
        jPanel1.add(idLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 390, -1, -1));

        colorValueLabel.setFont(new java.awt.Font("Dialog", 0, 9)); // NOI18N
        colorValueLabel.setText("(0,0,0)");
        colorValueLabel.setVisible(false);
        jPanel1.add(colorValueLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 420, -1, -1));
        ...
        jPanel1.add(widthField, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 280, 80, -1));
        ...
        jPanel1.add(heightField, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 310, 80, -1));
        ...
        jPanel1.add(boardResizeButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 350, 120, -1));
    ...
    private void FromBitmapImportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FromBitmapImportActionPerformed
        try {
            ...
            for(int y=0;y<sizeY;y++){
                for(int x=0;x<sizeX;x++){
                    if (grainGrowthBoard[x][y].getId() != -1)
                        grainGrowthBoard[x][y].setId(colorMapping.get(new Color(grainGrowthBoard[x][y].getR(),grainGrowthBoard[x][y].getG(),grainGrowthBoard[x][y].getB()))); 
                    }
            }
    ...
    private void FromTextFileImportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FromTextFileImportActionPerformed
            ...
            try {
                ...
                if (userSelection == JFileChooser.APPROVE_OPTION) {
                    ...
                    sizeX = Integer.parseInt(propperties[0]);
                    sizeY = Integer.parseInt(propperties[1]);
                    board.resizeXandY(sizeX, sizeY);
                    canvas.setGrainBoardSize(sizeX, sizeY);
                    while (true) {
                        line = in.readLine();
